...
# :command.user_lib
# src/lib/backends/find_backend.sh
find_backend() {
...
# src/lib/backends/list_backends_by_group.sh
...
# src/lib/projects/list_projects.sh
list_projects() {
    find "${PM_HOME}" -maxdepth 2 -mindepth 2 -type d ! -name '.*' \
        | sed "s!${PM_HOME}/!!"
}

# src/lib/projects/project_exists.sh
project_exists() {
...
# src/lib/spaces/list_spaces.sh
list_spaces() {
    find "${PM_HOME}" -maxdepth 1 -mindepth 1 -type d ! -name '.*' \
        | sed "s!${PM_HOME}/!!"
}

# src/lib/spaces/space_exists.sh
space_exists() {
    [[ -d "${PM_HOME}/${1}" ]] && return 0 || return 1
}

# src/lib/templates/find_template.sh
find_template() {
...
# src/lib/templates/list_templates_by_group.sh
...
# src/lib/validations/validate_backend_exists.sh
...
# src/lib/validations/validate_backend_is_missing.sh
...
# src/lib/validations/validate_project_exists.sh
...
# src/lib/validations/validate_project_is_missing.sh
...
# src/lib/validations/validate_template_exists.sh
...
# src/lib/validations/validate_template_is_missing.sh
...
pm_template_filter_command() {
  # src/template_filter_command.sh
  local only="${args[--only]}"
